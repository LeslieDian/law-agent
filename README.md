...
>
> 生成时间 **2026-09-21 22:05:47** ｜ 已完成 **12/21** 项
...
| MoE 队列 | Q4 MoE 客观 11,400 | ✅ 已完成 | 12552/11400 | — |
| MoE 队列 | Q5 MoE 生成 2,750 | 🔄 进行中 | 12552/14150 | — |
| MoE 队列 | Q6 A0 内部集 cap=1024 | ✅ 已完成 | 1000/1000 | — |
| MoE 队列 | 整队列标志 | ✅ 已完成 | — | MARKER_GATE_QUEUE_DONE |
| base 评测 | LexRubric 649 | ✅ 已完成 | 649/649 | cap=1536 |
| base 评测 | LexEval 客观+生成 14,150 | 🔄 进行中 | 12584/14150 | — |
...
| 收尾 | 汇总 + 出图 | ✅ 已完成 | — | collect_results.py + make_figures.py；最近一次 09-21 20:32 |
...
|---|---:|---:|---:|---:|---:|---|
| base (Qwen3-8B, 无微调) | — | — | — | — | — | 649 / 12584 / 0 |
| A0 (统一适配器) | 12.85 | — | — | 0.5378 | 0.5386 | 0 / 0 / 1000 |
| MoE-L2 (L2 门控混合) | 12.21 | — | — | — | — | 649 / 12552 / 1000 |
