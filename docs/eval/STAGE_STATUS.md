...
>
> 生成时间 **2026-09-21 11:07:40** ｜ 已完成 **6/20** 项

| 阶段 | 项 | 状态 | 进度 | 备注 |
|---|---|---|---|---|
| A0 评测链 | LexRubric 649 | ✅ 已完成 | 649/649 | cap=1536；AI 裁判判分 |
| A0 评测链 | LexEval 客观 11,400 + 生成 2,750 | 🔄 进行中 | 13224/14150 | 客观 cap=256 / 生成 cap=1536 |
...
| MoE 队列 | Q3 MoE LexRubric 649 | 🔄 进行中 | 32/649 | — |
...
| 收尾 | 汇总 + 出图 | ✅ 已完成 | — | collect_results.py + make_figures.py；最近一次 09-21 09:57 |
