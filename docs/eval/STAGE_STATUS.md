...
>
> 生成时间 **2026-09-20 22:59:00** ｜ 已完成 **2/19** 项

| 阶段 | 项 | 状态 | 进度 | 备注 |
|---|---|---|---|---|
| A0 评测链 | LexRubric 649 | ✅ 已完成 | 649/649 | cap=1536；AI 裁判判分 |
| A0 评测链 | LexEval 客观 11,400 + 生成 2,750 | 🔄 进行中 | 1056/14150 | 客观 cap=256 / 生成 cap=1536 |
| 阶段 6 门控 | L2 门控训练 | 🔄 进行中 | 758/1125 | 72 gates / 2.36M 参数；→ 等 gate_weights.pt |
...
| 收尾 | 汇总 + 出图 | ✅ 已完成 | — | collect_results.py + make_figures.py；最近一次 09-20 22:56 |
